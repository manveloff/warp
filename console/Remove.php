...
class Remove extends Command {
   ...
   * @var string
   */
  protected $signature = 'warp:remove';
   ...
   * @var string
   */
  protected $description = 'Remove WARP resource';
  ...
  public function handle() {
    ...
    // 1. Start constructor and get resource object to create

      // Create constructor instance
      $remove = \WARP::remove($this);

      // Start construction process and get $resource
      // - If it will return false, exit the process and notify.
      if($remove->construct() == false) {
        $this->comment($remove::EX_MSG);
        return;
      };
